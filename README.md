...
| Herm agent sandbox demo | Build the Herm + CPSL demo from the draft plan: Herm runs a bounded agent workflow inside a CPSL capsule with explicit files, modules, network rules, and inspectable output artifacts. | [#13](https://github.com/fundamental-research-labs/cpsl/issues/13), [draft PR #17](https://github.com/fundamental-research-labs/cpsl/pull/17) |
