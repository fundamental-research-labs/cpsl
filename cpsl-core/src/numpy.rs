...
impl UserData for NdArray {
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_meta_method("__len", |_, this, ()| {
            Ok(this.shape_vec()[0])
        });
    }
}
...
fn value_to_array(val: &Value) -> Result<NdArray, mlua::Error> {
    match val {
        ...
        _ => Err(mlua::Error::external("expected a numx array (userdata or table)")),
    }
}
    ...
    match v {
        ...
        Value::String(s) => {
            let s = s.to_str().map_err(|_| {
                mlua::Error::external("expected number, got non-UTF8 string")
            })?;
            s.parse::<f64>().map_err(|_| {
                mlua::Error::external(format!("expected number, got string {:?}", s))
            })
        }
...
fn parse_shape(val: &Value) -> Result<Vec<usize>, mlua::Error> {
    match val {
        ...
        Value::String(s) => {
            let s = s.to_str().map_err(|_| {
                mlua::Error::external("shape must be a number or table")
            })?;
            let n: usize = s.parse().map_err(|_| {
                mlua::Error::external(format!("shape must be a number or table, got string {:?}", s))
            })?;
            Ok(vec![n])
        }
        Value::Table(t) => {
...
fn is_scalar(v: &Value) -> bool {
    match v {
        ...
        Value::String(s) => s.to_str().map(|s| s.parse::<f64>().is_ok()).unwrap_or(false),
        _ => false,
    }
}
...
fn binop<F: Fn(f64, f64) -> f64>(a: &Value, b: &Value, f: F) -> Result<NdArray, mlua::Error> {
    ...
    match (&arr_a, &arr_b) {
        ...
        (NdArray::D2(a), NdArray::D2(b)) => {
            ...
            let result: Array2<f64> = Array2::from_shape_fn(a.dim(), |(i, j)| f(a[[i, j]], b[[i, j]]));
    ...
    F: Fn(&[f64]) -> f64,
{
    match axis {
        None => {
            ...
            if flat.is_empty() {
                return Err(mlua::Error::external(format!("{} of empty array", axis_name)));
            }
...
pub(crate) static NUMPY_DOC: ModuleDoc = ModuleDoc {
    ...
    functions: &[
        FnDoc {
            ...
            params: &[Param { name: "data", short: None, typ: ParamType::Table, required: true, fields: None }],
        ...
        FnDoc {
            ...
            params: &[Param { name: "shape", short: None, typ: ParamType::Value, required: true, fields: None }],
            returns: ReturnType::Value,
        ...
        FnDoc {
            ...
            params: &[
                Param { name: "shape", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "val", short: None, typ: ParamType::Number, required: true, fields: None },
            ],
            returns: ReturnType::Value,
            example: None,
        },
        FnDoc {
            ...
            params: &[
                Param { name: "start", short: None, typ: ParamType::Number, required: true, fields: None },
                Param { name: "stop", short: None, typ: ParamType::Number, required: true, fields: None },
                Param { name: "step", short: None, typ: ParamType::Number, required: false, fields: None },
            ],
            returns: ReturnType::Value,
        ...
        FnDoc {
            ...
            params: &[
                Param { name: "start", short: None, typ: ParamType::Number, required: true, fields: None },
                Param { name: "stop", short: None, typ: ParamType::Number, required: true, fields: None },
                Param { name: "count", short: None, typ: ParamType::Number, required: true, fields: None },
            ],
            returns: ReturnType::Value,
        ...
        FnDoc {
            ...
            params: &[Param { name: "n", short: None, typ: ParamType::Number, required: true, fields: None }],
            returns: ReturnType::Value,
            example: None,
        },
        FnDoc {
            ...
            params: &[Param { name: "values", short: None, typ: ParamType::Value, required: true, fields: None }],
            returns: ReturnType::Value,
            example: None,
        },
        FnDoc {
            ...
            params: &[
                Param { name: "a", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "b", short: None, typ: ParamType::Value, required: true, fields: None },
            ],
            returns: ReturnType::Value,
            example: None,
        },
        ...
        FnDoc {
            ...
            params: &[
                Param { name: "a", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "exp", short: None, typ: ParamType::Value, required: true, fields: None },
            ],
            returns: ReturnType::Value,
            example: None,
        },
        FnDoc {
            ...
            params: &[Param { name: "a", short: None, typ: ParamType::Value, required: true, fields: None }],
            returns: ReturnType::Value,
            example: None,
        },
        FnDoc {
        ...
        FnDoc {
            ...
            params: &[
                Param { name: "a", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "decimals", short: None, typ: ParamType::Number, required: false, fields: None },
            ],
            returns: ReturnType::Value,
            example: None,
        },
        FnDoc {
            ...
            params: &[
                Param { name: "a", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "axis", short: None, typ: ParamType::Number, required: false, fields: None },
            ],
            returns: ReturnType::Value,
        ...
        FnDoc {
            ...
            params: &[
                Param { name: "arrays", short: None, typ: ParamType::Table, required: true, fields: None },
                Param { name: "axis", short: None, typ: ParamType::Number, required: false, fields: None },
            ],
            returns: ReturnType::Value,
            example: None,
        ...
        FnDoc {
            ...
            params: &[
                Param { name: "cond", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "x", short: None, typ: ParamType::Value, required: true, fields: None },
                Param { name: "y", short: None, typ: ParamType::Value, required: true, fields: None },
            ],
            returns: ReturnType::Value,
...
pub fn register_numpy_globals(lua: &Lua) -> Result<(), mlua::Error> {
    ...
    np.set("add", lua.create_function(|lua, (a, b): (Value, Value)| {
        lua.create_userdata(binop(&a, &b, |x, y| x + y)?)
    })?)?;

    np.set("sub", lua.create_function(|lua, (a, b): (Value, Value)| {
        lua.create_userdata(binop(&a, &b, |x, y| x - y)?)
    })?)?;

    np.set("mul", lua.create_function(|lua, (a, b): (Value, Value)| {
        lua.create_userdata(binop(&a, &b, |x, y| x * y)?)
    })?)?;

    np.set("div", lua.create_function(|lua, (a, b): (Value, Value)| {
        lua.create_userdata(binop(&a, &b, |x, y| x / y)?)
    })?)?;

    np.set("pow", lua.create_function(|lua, (a, exp): (Value, Value)| {
        lua.create_userdata(binop(&a, &exp, |x, e| x.powf(e))?)
    })?)?;

    // Unary ops
    np.set("abs", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.abs()))
    })?)?;

    np.set("sqrt", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.sqrt()))
    })?)?;

    np.set("log", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.ln()))
    })?)?;

    np.set("exp", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.exp()))
    })?)?;

    np.set("sin", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.sin()))
    })?)?;

    np.set("cos", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.cos()))
    })?)?;

    np.set("tan", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.tan()))
    })?)?;

    np.set("floor", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.floor()))
    })?)?;

    np.set("ceil", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(arr.map_elem(|x| x.ceil()))
    })?)?;

    np.set("round", lua.create_function(|lua, (a, decimals): (Value, Option<i32>)| {
        let arr = value_to_array(&a)?;
    ...
    np.set("sum", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(aggregate(&arr, axis, sum_slice, "sum")?)
    })?)?;

    np.set("mean", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(aggregate(&arr, axis, mean_slice, "mean")?)
    })?)?;

    np.set("std", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(aggregate(&arr, axis, std_slice, "std")?)
    })?)?;

    np.set("var", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(aggregate(&arr, axis, var_slice, "var")?)
    })?)?;

    np.set("min", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(aggregate(&arr, axis, min_slice, "min")?)
    })?)?;

    np.set("max", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(aggregate(&arr, axis, max_slice, "max")?)
    })?)?;

    np.set("argmin", lua.create_function(|_, a: Value| {
        let arr = value_to_array(&a)?;
        let flat = arr.to_flat_vec();
        if flat.is_empty() {
            return Err(mlua::Error::external("argmin of empty array"));
        }
        let idx = flat.iter().enumerate()
            .min_by(|(_, a), (_, b)| a.partial_cmp(b).unwrap_or(std::cmp::Ordering::Equal))
            .unwrap().0;
        Ok(idx + 1) // 1-based for Lua
    })?)?;

    np.set("argmax", lua.create_function(|_, a: Value| {
        let arr = value_to_array(&a)?;
        let flat = arr.to_flat_vec();
        if flat.is_empty() {
    ...
    np.set("cumsum", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        match axis {
            None => {
                let flat = arr.to_flat_vec();
    ...
    np.set("shape", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let s = arr.shape_vec();
        let t = lua.create_table()?;
    ...
    np.set("reshape", lua.create_function(|lua, (a, shape): (Value, Value)| {
        let arr = value_to_array(&a)?;
        let s = parse_shape(&shape)?;
        let flat = arr.to_flat_vec();
    ...
    np.set("transpose", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        match arr {
    ...
    np.set("flatten", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        lua.create_userdata(NdArray::D1(Array1::from_vec(arr.to_flat_vec())))
    })?)?;

    np.set("concatenate", lua.create_function(|lua, (arrays, axis): (mlua::Table, Option<i64>)| {
        ...
        match axis {
            0 => {
                ...
                for m in &mats {
                    if m.ncols() != ncols {
                        return Err(mlua::Error::external("all arrays must have same ncols for axis=0 concat"));
                    }
            ...
            1 => {
                ...
                for m in &mats {
                    if m.nrows() != nrows {
                        return Err(mlua::Error::external("all arrays must have same nrows for axis=1 concat"));
                    }
                }
    ...
    np.set("stack", lua.create_function(|lua, (arrays, axis): (mlua::Table, Option<i64>)| {
        let axis = axis.unwrap_or(0);
        let arrays = unwrap_py_table(&arrays)?;
        let len = arrays.raw_len();
        if len == 0 {
        ...
        for v in &vecs {
            if v.len() != elem_len {
                return Err(mlua::Error::external("all arrays must have same shape for stack"));
            }
        }
    ...
    np.set("sort", lua.create_function(|lua, (a, axis): (Value, Option<i64>)| {
        let arr = value_to_array(&a)?;
        match axis {
            None | Some(0) => {
                match arr {
    ...
    np.set("argsort", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let flat = arr.to_flat_vec();
        let mut indices: Vec<usize> = (0..flat.len()).collect();
        indices.sort_by(|&a, &b| flat[a].partial_cmp(&flat[b]).unwrap_or(std::cmp::Ordering::Equal));
        // 1-based for Lua
    ...
    let where_fn = lua.create_function(|lua, (cond, x, y): (Value, Value, Value)| {
        ...
        if cf.len() != xf.len() || cf.len() != yf.len() {
            return Err(mlua::Error::external("where: all arrays must have same length"));
        }
        let result: Vec<f64> = cf.iter().zip(xf.iter().zip(yf.iter()))
    ...
    np.set("unique", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
    ...
    np.set("tolist", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
    ...
    np.set("dot", lua.create_function(|lua, (a, b): (Value, Value)| {
        let arr_a = value_to_array(&a)?;
        let arr_b = value_to_array(&b)?;
        match (&arr_a, &arr_b) {
            (NdArray::D1(a), NdArray::D1(b)) => {
                if a.len() != b.len() {
                    return Err(mlua::Error::external("dot: 1D arrays must have same length"));
                }
            ...
            (NdArray::D2(a), NdArray::D1(b)) => {
                if a.ncols() != b.len() {
                    return Err(mlua::Error::external("dot: matrix cols must match vector length"));
                }
                let result = a.dot(b);
            ...
            (NdArray::D1(a), NdArray::D2(b)) => {
                if a.len() != b.nrows() {
                    return Err(mlua::Error::external("dot: vector length must match matrix rows"));
                }
    ...
    np.set("matmul", lua.create_function(|lua, (a, b): (Value, Value)| {
        let arr_a = value_to_array(&a)?;
        let arr_b = value_to_array(&b)?;
        let ma = arr_a.as_2d();
        let mb = arr_b.as_2d();
...
pub fn register_numpy_linalg(lua: &Lua) -> Result<(), mlua::Error> {
    ...
    linalg.set("inv", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let m = arr.as_2d();
    ...
    linalg.set("det", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let m = arr.as_2d();
        if m.nrows() != m.ncols() {
    ...
    linalg.set("solve", lua.create_function(|lua, (a, b): (Value, Value)| {
        let arr_a = value_to_array(&a)?;
        let arr_b = value_to_array(&b)?;
        let ma = arr_a.as_2d();
    ...
    linalg.set("eig", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let m = arr.as_2d();
        if m.nrows() != m.ncols() {
        ...
        result.set("values", lua.create_userdata(NdArray::D1(Array1::from_vec(eigenvalues)))?)?;
        result.set("vectors", lua.create_userdata(NdArray::D2(vectors))?)?;
        Ok(Value::Table(result))
    })?)?;

    // numx.linalg.svd(a) → {u, s, vt}
    linalg.set("svd", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let m = arr.as_2d();
        let fm = ndarray_to_faer(&m);

        let svd = fm.as_ref().svd()
        ...
        result.set("s", lua.create_userdata(NdArray::D1(Array1::from_vec(s_vals)))?)?;
        result.set("vt", lua.create_userdata(NdArray::D2(vt))?)?;
        Ok(Value::Table(result))
    })?)?;

    // numx.linalg.norm(a) → Frobenius/L2 norm
    linalg.set("norm", lua.create_function(|lua, a: Value| {
        let arr = value_to_array(&a)?;
        let flat = arr.to_flat_vec();
...
pub fn register_numpy_random(lua: &Lua) -> Result<(), mlua::Error> {
    ...
    {
        let rng = rng.clone();
        random.set("seed", lua.create_function(move |_, n: u64| {
            let mut r = rng.lock().map_err(|e| mlua::Error::external(format!("RNG lock poisoned: {}", e)))?;
    ...
    {
        let rng = rng.clone();
        random.set("rand", lua.create_function(move |lua, shape: Option<Value>| {
            let s = match shape {
    ...
    {
        let rng = rng.clone();
        random.set("randn", lua.create_function(move |lua, shape: Option<Value>| {
            let s = match shape {
                Some(v) => parse_shape(&v)?,
                None => vec![1],
            };
            let total: usize = s.iter().product();
            let mut r = rng.lock().map_err(|e| mlua::Error::external(format!("RNG lock poisoned: {}", e)))?;
            let dist = Normal::new(0.0, 1.0).map_err(|e| mlua::Error::external(e.to_string()))?;
    ...
    {
        let rng = rng.clone();
        random.set("randint", lua.create_function(move |lua, (low, high, shape): (i64, i64, Option<Value>)| {
            let s = match shape {
                Some(v) => parse_shape(&v)?,
                None => vec![1],
            };
            let total: usize = s.iter().product();
            let mut r = rng.lock().map_err(|e| mlua::Error::external(format!("RNG lock poisoned: {}", e)))?;
            let dist = Uniform::new(low, high).map_err(|e| mlua::Error::external(format!("randint: {}", e)))?;
    ...
    {
        let rng = rng.clone();
        random.set("choice", lua.create_function(move |lua, (a, size): (Value, Option<usize>)| {
            let arr = value_to_array(&a)?;
            let flat = arr.to_flat_vec();
            if flat.is_empty() {
    ...
    {
        let rng = rng.clone();
        random.set("normal", lua.create_function(move |lua, (mean, std_val, shape): (f64, f64, Option<Value>)| {
            let s = match shape {
                Some(v) => parse_shape(&v)?,
                None => vec![1],
            };
            let total: usize = s.iter().product();
            let mut r = rng.lock().map_err(|e| mlua::Error::external(format!("RNG lock poisoned: {}", e)))?;
            let dist = Normal::new(mean, std_val).map_err(|e| mlua::Error::external(e.to_string()))?;
            let vals: Vec<f64> = (0..total).map(|_| r.sample(&dist)).collect();
            match s.len() {
                1 => lua.create_userdata(NdArray::D1(Array1::from_vec(vals))),
                2 => {
    ...
    {
        let rng = rng.clone();
        random.set("uniform", lua.create_function(move |lua, (low, high, shape): (f64, f64, Option<Value>)| {
            let s = match shape {
                Some(v) => parse_shape(&v)?,
                None => vec![1],
            };
            let total: usize = s.iter().product();
            let mut r = rng.lock().map_err(|e| mlua::Error::external(format!("RNG lock poisoned: {}", e)))?;
            let dist = Uniform::new(low, high).map_err(|e| mlua::Error::external(format!("uniform: {}", e)))?;
            let vals: Vec<f64> = (0..total).map(|_| r.sample(&dist)).collect();
            match s.len() {
                1 => lua.create_userdata(NdArray::D1(Array1::from_vec(vals))),
                2 => {
