...
fn test_css_styled_html_to_pdf() {
    ...
    println!("  PASS: test_css_styled_html_to_pdf ({} bytes)", pdf.len());
}
...
fn test_flexbox_grid_layout() {
    ...
    println!("  PASS: test_flexbox_grid_layout ({} bytes)", pdf.len());
}
...
<body>
    ...
    println!("  PASS: test_full_html_document ({} bytes)", pdf.len());
}
